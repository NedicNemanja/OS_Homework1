...
_DEPS = CheckStage.h Component.h ErrorCodes.h ManufactureStage.h PaintshopStage.h SharedMem.h
#pattern matching from  _DEPS to include directory
DEPS = $(patsubst %,$(INCLUDE_DIR)/%,$(_DEPS))

_OBJ = CheckStage.o Component.o main.o ManufactureStage.o PaintshopStage.o SharedMem.o
